...
const Maxar = () => Item({
    ...
    description: [
        'Developing mission critical software solutions for utilization throughout the entire ground software stack.',
        ...
        'Building scalable computer systems to ingest massive data streams from an upcoming constellation of satellites.',
        'Deploying services with automated pipelines and improving test coverage to ensure reliable software releases.',
...
const TuSimple = () => Item({
    ...
    description: [
        ...
        'Designed and implemented distributed data pipelines, applying computational geometry algorithms to process high-resolution map data totaling hundreds of gigabytes.',
    ],
